...
const Service2 = ({ t }) => {
  ...
  const serviceData = t?.services?.items?.[1] || t?.services?.items?.[1]; // service 1 (painting services)
  const serviceImage = { 
    src: "/painting.jpg", 
  ...
  const beforeAfterProjects = [
    {
      before: "/WhatsApp Image 2025-07-31 at 11.28.43 PM (2) 1.png",
      after: "/WhatsApp Image 2025-07-31 at 11.26.11 PM (1) 1 (1).png",
    ...
    {
      before: "/WhatsApp Image 2025-06-29 at 16.33.45_3b542140.jpg",
      after: "/WhatsApp Image 2025-07-27 at 1.06.10 AM (1) 1.png",
      title: "Salle de bain"
    },
    {
      before: "/WhatsApp Image 2025-07-31 at 11.30.33 PM (1) 1.png",
      after: "/WhatsApp Image 2025-07-31 at 11.30.32 PM 1.png",
        ...
        <div className="relative h-[250px] sm:h-[300px] md:h-[400px] lg:h-[500px] xl:h-[700px] rounded-2xl sm:rounded-3xl overflow-hidden">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center px-3 sm:px-4 md:px-6 z-10">
            <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-2 sm:mb-3 md:mb-4 text-center leading-tight">
              {serviceData?.title || "Services de peinture et rénovation"}
            </h1>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-6 mt-8">
        <div className="rounded-2xl p-8 md:p-12">
              ...
              {beforeAfterProjects.map((project, index) => (
                <div key={index} className="relative group">
                  <div 
                    ...
                    className="relative h-[200px] sm:h-[250px] md:h-[300px] rounded-xl overflow-hidden shadow-lg cursor-ew-resize select-none"
                  ...
                  >
                    ...
                    >
                      {/* Drag Handle */}
                      <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-full p-2 md:p-3 shadow-lg">
                        <div className="flex items-center gap-1">
                          <MdNavigateBefore className="w-4 h-4 md:w-5 md:h-5 text-gray-600" />
                          <MdNavigateNext className="w-4 h-4 md:w-5 md:h-5 text-gray-600" />
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <p className="mt-6 md:mt-20 font-bold text-base md:text-lg text-center text-main px-4">
            {serviceData?.descriptionOutro || "Notre expertise en peinture garantit un résultat durable et esthétique."}
          </p>
